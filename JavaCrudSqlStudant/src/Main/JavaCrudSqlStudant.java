...
public class JavaCrudSqlStudant {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					JavaCrudSqlStudant window = new JavaCrudSqlStudant();
	...
	public void Connect() {
		...
		try {
			...
			con = DriverManager.getConnection("jdbc:mysql://localhost:3308/school","eder","");
	...
	private void initialize() {
		...
		frame.setTitle("CRUD em Java com persistencia MySQL");
		...
		JLabel lblNewLabel = new JLabel("CRUD Java MySql Swing");
		lblNewLabel.setHorizontalAlignment(SwingConstants.CENTER);
		lblNewLabel.setFont(new Font("Tahoma", Font.BOLD, 30));
		lblNewLabel.setBounds(65, 42, 456, 39);
